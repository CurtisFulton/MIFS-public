...
namespace Mifs.Supervisor
{
    ...
    public class IntegrationHostFactory : IIntegrationHostFactory
    {
                                                 ...
                                                 CancellationToken cancellationToken = default)
        {
            ...
            // If an ApplicationFeatureSurrogate exists it means a Kestrel server exists for this host.
            // So we want to add it to the ProxyRouteCollection.
            var applicationFeatures = host.Services.GetService<ApplicationFeatureSurrogate>();
        ...
        private void SetupIntegrationServerProxy(string integrationName, ApplicationFeatureSurrogate applicationFeatures)
        {
